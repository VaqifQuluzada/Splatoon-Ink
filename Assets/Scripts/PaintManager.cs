...
public class PaintManager : Singleton<PaintManager>
{
	...
	public void PaintEntireObject(Paintable paintable, Color color)
	{
		RenderTexture mask = paintable.getMask();
		RenderTexture uvIslands = paintable.getUVIslands();
		RenderTexture extend = paintable.getExtend();
		...
		paintMaterial.SetFloat(radiusID, 999f); // Very large radius to cover all UVs
		paintMaterial.SetVector(positionID, new Vector4(0.5f, 0.5f, 0, 0)); // Center in UV space
		paintMaterial.SetTexture(textureID, support);
